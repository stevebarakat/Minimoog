    ...
    this.port.onmessage = (e) => {
      ...
      if (e.data instanceof ArrayBuffer) {
        WebAssembly.instantiate(e.data)
          ...
          .catch((error) => {
            console.error(
              "MusicDSP processor: WASM instantiation failed:",
              error
            );
...
registerProcessor("musicdsp-worklet-processor", MusicDSPWorkletProcessor);
