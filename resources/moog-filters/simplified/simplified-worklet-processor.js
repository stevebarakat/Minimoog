    ...
    this.port.onmessage = (e) => {
      ...
      if (e.data instanceof ArrayBuffer) {
        WebAssembly.instantiate(e.data)
          ...
          .catch((error) => {
            console.error(
              "Simplified processor: WASM instantiation failed:",
              error
            );
...
registerProcessor("simplified-worklet-processor", SimplifiedWorkletProcessor);
