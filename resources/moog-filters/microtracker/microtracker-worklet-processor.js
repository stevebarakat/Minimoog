...
/**
 * Microtracker Moog filter worklet processor
 * Based on Magnus Jonsson's implementation with optimized coefficients
 * This implementation provides excellent stability and musical quality
 */
class MicrotrackerWorkletProcessor extends AudioWorkletProcessor {
  constructor() {
    super();
    ...
    this.port.onmessage = (e) => {
      ...
      if (e.data instanceof ArrayBuffer) {
        WebAssembly.instantiate(e.data)
          ...
          .catch((error) => {
            console.error(
              "Microtracker processor: WASM instantiation failed:",
              error
            );
...
registerProcessor(
  "microtracker-worklet-processor",
  MicrotrackerWorkletProcessor
);
