    ...
    this.port.onmessage = (e) => {
      ...
      if (e.data instanceof ArrayBuffer) {
        WebAssembly.instantiate(e.data)
          ...
          .catch((error) => {
            console.error(
              "Krajeski processor: WASM instantiation failed:",
              error
            );
...
registerProcessor("krajeski-worklet-processor", KrajeskiWorkletProcessor);
