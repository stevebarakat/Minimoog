...
/**
 * Stilson filter worklet processor
 * Based on Tim Stilson's Moog VCF analysis with compromise poles at z = -0.3
 ...
 */
class StilsonWorkletProcessor extends AudioWorkletProcessor {
  constructor() {
    super();
    ...
    this.port.onmessage = (e) => {
      ...
      if (e.data instanceof ArrayBuffer) {
        WebAssembly.instantiate(e.data)
          ...
          .catch((error) => {
            console.error(
              "Stilson processor: WASM instantiation failed:",
              error
            );
...
registerProcessor("stilson-worklet-processor", StilsonWorkletProcessor);
