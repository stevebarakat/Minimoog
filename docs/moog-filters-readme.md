...
- **[Moog Filter Implementations](moog-filter-implementations.md)** - Current WASM-based implementation details
- **[AudioWorklet Integration Guide](audio-worklet-integration-guide.md)** - Performance-optimized processor integration
- **[Authentic Minimoog Filter Improvements](authentic-minimoog-filter-improvements.md)** - Filter characteristics and improvements
