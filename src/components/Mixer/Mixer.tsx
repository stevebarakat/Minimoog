    ...
    <Section data-onboarding="mixer">
      <Row style={{ padding: "0 var(--spacing-md)" }}>
        <Column gap={COLUMN_GAP}>
          <Row>
            <Tooltip content={getTooltipContent("oscillator-1-volume")}>
              <Knob
                valueLabels={{
                  0: "0",
                  2: "2",
            ...
            <Line />
            <Tooltip content={getTooltipContent("oscillator-1")}>
              <RockerSwitch
          ...
          <Row>
            <Tooltip content={getTooltipContent("oscillator-2-volume")}>
              <Knob
                valueLabels={{
                  0: "0",
                  2: "2",
            ...
            <Line />
            <Tooltip content={getTooltipContent("oscillator-2")}>
              <RockerSwitch
                style={ROCKER_SWITCH_POSITION}
                theme="blue"
          ...
          <Row>
            <Tooltip content={getTooltipContent("oscillator-3-volume")}>
              <Knob
                valueLabels={{
                  0: "0",
                  2: "2",
            ...
            <Line />
            <Tooltip content={getTooltipContent("oscillator-3")}>
              <RockerSwitch
                style={ROCKER_SWITCH_POSITION}
                theme="blue"
