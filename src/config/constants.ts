...
export const SYNTH_CONFIG = {
  ...
  VOLUME: {
    ...
    EFFECTS: { MIN: 0, MAX: 10, DEFAULT: 7 },
  },
  ...
  MIXER: {
    ...
    EXTERNAL_INPUT: {
      VOLUME: { MIN: 0.001, MAX: 10, DEFAULT: 5 },
    },
  },

  FILTER: {
    CUTOFF: { MIN: -5, MAX: 5, DEFAULT: 3.9 },
  ...
  // ============================================================================
  DELAY: {
    ENABLED: { DEFAULT: true }, // Changed from false to true for testing
  ...
  // ============================================================================
  REVERB: {
    ENABLED: { DEFAULT: true }, // Changed from false to true so reverb is on by default
...
export const DEFAULT_PRESET_ID: string | null = "classic-minimoog-lead"; // Using classic Minimoog lead preset as default

// ============================================================================
// DEFAULT SYNTH STATE VALUES (FALLBACK - USED WHEN NO PRESET IS LOADED)
// ============================================================================
...
export const DEFAULT_SYNTH_STATE = {
  ...
  effectsVolume: createVolumeRange(SYNTH_CONFIG.VOLUME.EFFECTS.DEFAULT),
...
export const UI = {
  DEFAULTS: {
    KEYBOARD_INSTRUCTIONS_OPEN: false,
  },
} as const;
